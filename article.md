...
Это строчкой вы вносим в текущее пронстранство имён варианты перечисления `Digit`. Это позволяет нам писать, например, `D5` вместо `Digit::D5`.
...
## За пределами десятка

Теперь займёмся числами, которые являются произведениями десяти и меньше ста (10, 20, 30, 40, 50, 60, 70, 80, 90). Пойдём по тому же пути, что и в случае с цифрой: определим перечисление с вариантом для каждого значения и будем разбирать их для получения строкового значения.

...Или нет? В конце-концов, у нас уже есть перечисление с цифрами, так что можно представить десятки как произведение цифры на 10. Что ж, так и поступим, тем более что, как будет видно в дальнейшем, это упростит нам создание значений этого типа.
...
Здесь мы объявляем [кортежную структуру](https://doc.rust-lang.org/book/ch05-01-defining-structs.html#using-tuple-structs-without-named-fields-to-create-different-types). У такой структуры есть имя, но нет имён у её полей. Конечно, мы могли бы определить и более привычную структуру с одним именованным полем, но это было бы более громоздко и в нашем случае не дало бы существенных выгод, вдобавок эта структура фактически является тонкой обёрткой над `Digit` и имеет то же представление в памяти, но даёт иную семантику, то есть реализует [паттерн newtype](https://github.com/rust-unofficial/patterns/blob/master/patterns/newtype.md), а для них в Rust принято использовать именно кортежные структуры.

Добавим функции создания и печати в словесном виде:

```rust
impl Tens {
    fn new(n: u32) -> Option<Self> {
        Digit::new(n / 10).map(Tens)
    }
}

fn print_tens(tens: Tens) {
    use Digit::*;
    ...
    match tens.0 {
        ...
        D6 => print!("шестьдесят"),
        D7 => print!("семьдесят"),
        D8 => print!("восемьдесят"),
        D9 => print!("девяносто"),
    }
}
```

Отлично, [оно работает](https://play.rust-lang.org/?code=%23%5Bderive%28Clone%2C%20Copy%29%5D%0Apub%20enum%20Digit%20%7B%0A%20%20%20%20D1%20%3D%200%2C%20D2%2C%20D3%2C%20D4%2C%20D5%2C%20D6%2C%20D7%2C%20D8%2C%20D9%2C%0A%7D%0A%0Aimpl%20Digit%20%7B%0A%20%20%20%20fn%20new%28n%3A%20u32%29%20-%3E%20Option%3CSelf%3E%20%7B%0A%20%20%20%20%20%20%20%20use%20Digit%3A%3A%2A%3B%0A%0A%20%20%20%20%20%20%20%20const%20ROW%3A%20%5BDigit%3B%209%5D%20%3D%20%5BD1%2C%20D2%2C%20D3%2C%20D4%2C%20D5%2C%20D6%2C%20D7%2C%20D8%2C%20D9%5D%3B%0A%0A%20%20%20%20%20%20%20%20match%20n%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%201..%3D9%20%3D%3E%20Some%28ROW%5Bn%20as%20usize%20-%201%5D%29%2C%0A%20%20%20%20%20%20%20%20%20%20%20%20_%20%3D%3E%20None%2C%0A%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%7D%0A%7D%0A%0Astruct%20Tens%28Digit%29%3B%0A%0Aimpl%20Tens%20%7B%0A%20%20%20%20fn%20new%28n%3A%20u32%29%20-%3E%20Option%3CSelf%3E%20%7B%0A%20%20%20%20%20%20%20%20Digit%3A%3Anew%28n%20%2F%2010%29.map%28Tens%29%0A%20%20%20%20%7D%0A%7D%0A%0Afn%20print_tens%28tens%3A%20Tens%29%20%7B%0A%20%20%20%20use%20Digit%3A%3A%2A%3B%0A%20%20%20%20%0A%20%20%20%20match%20tens.0%20%7B%0A%20%20%20%20%20%20%20%20D1%20%3D%3E%20print%21%28%22%D0%B4%D0%B5%D1%81%D1%8F%D1%82%D1%8C%22%29%2C%0A%20%20%20%20%20%20%20%20D2%20%3D%3E%20print%21%28%22%D0%B4%D0%B2%D0%B0%D0%B4%D1%86%D0%B0%D1%82%D1%8C%22%29%2C%0A%20%20%20%20%20%20%20%20D3%20%3D%3E%20print%21%28%22%D1%82%D1%80%D0%B8%D0%B4%D1%86%D0%B0%D1%82%D1%8C%22%29%2C%0A%20%20%20%20%20%20%20%20D4%20%3D%3E%20print%21%28%22%D1%81%D0%BE%D1%80%D0%BE%D0%BA%22%29%2C%0A%20%20%20%20%20%20%20%20D5%20%3D%3E%20print%21%28%22%D0%BF%D1%8F%D1%82%D1%8C%D0%B4%D0%B5%D1%81%D1%8F%D1%82%22%29%2C%0A%20%20%20%20%20%20%20%20D6%20%3D%3E%20print%21%28%22%D1%88%D0%B5%D1%81%D1%82%D1%8C%D0%B4%D0%B5%D1%81%D1%8F%D1%82%22%29%2C%0A%20%20%20%20%20%20%20%20D7%20%3D%3E%20print%21%28%22%D1%81%D0%B5%D0%BC%D1%8C%D0%B4%D0%B5%D1%81%D1%8F%D1%82%22%29%2C%0A%20%20%20%20%20%20%20%20D8%20%3D%3E%20print%21%28%22%D0%B2%D0%BE%D1%81%D0%B5%D0%BC%D1%8C%D0%B4%D0%B5%D1%81%D1%8F%D1%82%22%29%2C%0A%20%20%20%20%20%20%20%20D9%20%3D%3E%20print%21%28%22%D0%B4%D0%B5%D0%B2%D1%8F%D0%BD%D0%BE%D1%81%D1%82%D0%BE%22%29%2C%0A%20%20%20%20%7D%0A%7D%0A%0Afn%20main%28%29%20%7B%0A%20%20%20%20let%20twenty%20%3D%20Tens%3A%3Anew%2820%29%3B%0A%20%20%20%20%0A%20%20%20%20match%20twenty%20%7B%0A%20%20%20%20%20%20%20%20Some%28val%29%20%3D%3E%20print_tens%28val%29%2C%0A%20%20%20%20%20%20%20%20None%20%3D%3E%20print%21%28%22%D0%B4%D0%B5%D1%81%D1%8F%D1%82%D0%BA%D0%BE%D0%B2%20%D0%BD%D0%B5%D1%82%22%29%2C%0A%20%20%20%20%7D%0A%7D)!
